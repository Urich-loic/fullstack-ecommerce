    ...
    <div className="">
            ...
            <Card onClick={()=>handleShow()} className="notification-card">
              <Card.Body>
                ...
                <p className="py-1  px-0 text-primary m-0">
                  <span class="material-symbols-outlined">notifications</span> Date: 22/12/2010 | Status:
                  Unread
                </p>
              </Card.Body>
            </Card>
          ...
          <Col className="p-1" md={6} lg={6} sm={12} xs={12}>
            <Card className="notification-card">
              <Card.Body>
                ...
                <p className="py-1  px-0 text-success m-0">
                 <span class="material-symbols-outlined">notifications</span> Date: 22/12/2010 | Status: Read
                </p>
              </Card.Body>
            </Card>
          </Col>
      ...
      <Modal show={show} onHide={()=>handleClose()}>
        <Modal.Header closeButton>
          <h6>
            <span class="material-symbols-outlined">notifications</span> Date:11/05/2021
          </h6>
        </Modal.Header>
        <Modal.Body>
